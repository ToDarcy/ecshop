...
function showtime()
{
  ...
  if (dateLeft > 0)
  {
    Temp = "<li>" + hourZero + hourLeft + _hour + "</li>" + "<li>" + minuteZero + minuteLeft + _minute + "</li>" + "<li>" + secondZero + secondLeft + _second + "</li>";
  }
  else
  {
    if (hourLeft > 0)
...
function onload_Sales_Time(now_time)
{
  /* 第一次运行时初始化语言项目 */
  try
  {
