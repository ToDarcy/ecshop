<div class="search" style="display:none;">
	<div class="ect-bg">
		<header class="ect-header ect-margin-tb ect-margin-lr text-center"><span><?php echo $this->_var['lang']['search']; ?></span><a href="javascript:;" class="herder-close" onClick="closeSearch();">×</a></header>
	</div>
	<div class="ect-padding-lr">
		...
		<div class="input-search"> <span>
			<input name="keywords" type="search" placeholder="<?php echo $this->_var['lang']['no_keywords']; ?>" autofocus="autofocus" id="keywordBox">
			</span>
		<button type="submit" value="<?php echo $this->_var['lang']['search']; ?>" onclick="return check('keywordBox')"><i class="iconfont">&#xe617;</i></button>
		</div>
		</form>
