...
<?php echo $this->fetch('bootstrap.htm'); ?>
...
<table class="table table-striped table-bordered">
  <tr>
    <th colspan="4"><?php echo $this->_var['lang']['order_stat']; ?></th>
  </tr>
  <tr>
...
<table class="table table-striped table-bordered">
  <tr>
    <th colspan="4"><?php echo $this->_var['lang']['goods_stat']; ?></th>
  </tr>
  <tr>
...
<table class="table table-striped table-bordered">
  <tr>
    <th colspan="4"><?php echo $this->_var['lang']['virtual_card_stat']; ?></th>
  </tr>
  <tr>
    <td width="20%"><?php echo $this->_var['lang']['goods_count']; ?></td>
...
<table class="table table-striped table-bordered">
  <tr>
    <th colspan="4"><?php echo $this->_var['lang']['system_info']; ?></th>
  </tr>
  <tr>
...
onload = function()
{
  var is_ecshop = <?php echo $this->_var['is_ecshop']; ?>;
  if(is_ecshop){
    doLinkAll(false);
  }
  /* 检查订单 */
