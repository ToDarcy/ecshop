...
$(function () {
	...
	//http://api.ecmoban.com/record.php?mod=login&url=<?php echo $this->_var['shop_url']; ?>
...
?>
    <dl>
        ...
        <?php $_from = $this->_var['menu']['children']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'child');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['child']):
?>
  		<dd><a href="javascript:void(0)" onclick="openItem('<?php echo $this->_var['k']; ?>,<?php echo $this->_var['child']['action']; ?>,<?php echo $this->_var['key']; ?>');"><?php echo $this->_var['child']['label']; ?></a></dd>
      ...
      <td colspan="2" height="90" class="mainhd"><div class="layout-header"> <!-- Title/Logo - can use text instead of image -->
          ...
          <div id="topnav" class="top-nav">
            <ul>
              ...
              <li><a href="privilege.php?act=modif" target="workspace"><span><?php echo $this->_var['lang']['profile']; ?></span></a></li>
              <li><a href="privilege.php?act=modif" target="workspace">您好&nbsp;:&nbsp;<?php echo $_SESSION['admin_name']; ?></a></li>
            </ul>
          </div>
...
?>
<li><a class="link<?php if ($this->_foreach['menu']['iteration'] == 1): ?> actived<?php endif; ?>" id="nav_<?php echo $this->_var['k']; ?>" href="javascript:;" onclick="openItem('<?php echo $this->_var['k']; ?>');"><span><?php echo $this->_var['menu']['label']; ?></span></a></li>
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    ...
    foreach ($_from AS $this->_var['key'] => $this->_var['menu']):
?>
          <ul id="sort_<?php echo $this->_var['key']; ?>">
            <li>
              <dl>
                <dd>
                  <ol>
    ...
    foreach ($_from AS $this->_var['k'] => $this->_var['child']):
?>
                    <li><a href="JavaScript:void(0);" name="item_<?php echo $this->_var['key']; ?>_<?php echo $this->_var['k']; ?>" id="item_<?php echo $this->_var['key']; ?>_<?php echo $this->_var['k']; ?>" onclick="openItem('<?php echo $this->_var['k']; ?>,<?php echo $this->_var['child']['action']; ?>,<?php echo $this->_var['key']; ?>');"><?php echo $this->_var['child']['label']; ?></a></li>
                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                  </ol>
                </dd>
              </dl>
