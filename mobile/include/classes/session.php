...
class session
{
    ...
    public function __construct(&$db, $session_table, $session_data_table, $session_name = 'ECTOUCH_ID', $session_id = '')
    {
    ...
    function destroy_session()
    {
        ...
        if (!empty($global->ecs))
        {
            $this->db->query('DELETE FROM ' . $global->ecs->table('cart') . " WHERE session_id = '$this->session_id'");
        }
