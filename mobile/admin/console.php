...
{
    $smarty->display('2016_calculator.htm');
}
...
//    $modules = read_modules('../includes/modules/shipping');
    ...
    $smarty->display('2016_setting_first.htm');
}
...
//            $modules = read_modules('../includes/modules/payment');
    ...
    $smarty->display('2016_setting_second.htm');
}
...
elseif ($_REQUEST['act'] == 'third')
{
    ...
    $smarty->display('2016_setting_third.htm');
}
...
{
    assign_query_info();
    $smarty->display('2016_about_us.htm');
}
