...
?> 
          <li <?php if ($this->_var['key'] == 0): ?>class="current"<?php endif; ?>><a href="javascript:;">套餐<span class="icon_step"><?php echo $this->_var['comboTab'][$this->_var['key']]; ?></span></a>
          </li>
...
?>
      <div class="panel" <?php if ($this->_foreach['foo']['iteration'] == 1): ?>style="display: block;"<?php endif; ?>>
        <form name="m_goods_<?php echo $this->_var['key']; ?>" method="post" action="" onSubmit="return false;">
          <h4></h4>
          <ul class="cle">
            <div style="float:left;"><li><a target="_blank" class="pic" href="<?php echo $this->_var['goods']['url']; ?>"> <img alt="<?php echo $this->_var['goods']['goods_name']; ?>" src="<?php echo $this->_var['goods']['goods_thumb']; ?>"></a>
...
?> 
                ...
                <li class="plus"></li>
                <li> <a target="_blank" class="pic" href="<?php echo $this->_var['goods_list']['url']; ?>"> <img alt="<?php echo $this->_var['goods_list']['goods_name']; ?>" src="<?php echo $this->_var['goods_list']['goods_thumb']; ?>"></a>
