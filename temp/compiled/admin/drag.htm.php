...
<div class="" onClick="toggleMenu();">
    <div id="show_right" style="display:none; position:relative; height:100%; width:12px; background:#293949; cursor:pointer;"></div>
    <table height="100%" cellspacing="0" cellpadding="0" id="tbl" style=" position:absolute; right:0;top:0%;  background: #293949;">
