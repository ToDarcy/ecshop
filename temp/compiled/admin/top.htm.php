...
.submenu-div .user_name, .submenu-div .user_name a {
	padding-right:20px;	
	}
.submenu-div ul {
  margin: 0;
...
<?php echo $this->smarty_insert_scripts(array('files'=>'../js/transport_jquery.js,../js/jquery.js,../js/bootstrap.js')); ?>
...
<div id="header-div">
  ...
  <div class="submenu-div">
   ...
   你好！管理员 <?php echo $this->_var['admin_name']; ?>
   <span class="caret"></span>
   </a>
   <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
   <li><a href="privilege.php?act=logout" target="_top">
   <?php echo $this->_var['lang']['signout']; ?></a></li>
   </ul>
   </li>
     <li><a href="index.php?act=clear_cache" target="main-frame" class="fix-submenu"><img src="images/qingchu.png" style="border:none;"/><span><?php echo $this->_var['lang']['clear_cache']; ?></span></a></li>
      ...
      <li style="width:102px;border-left:none;"><a href=" http://down.duodl.com" target="main-frame" style="color:#FF6C60; width:102px; font-weight:bold;"><img src="images/topmune_09.png" style="border:none;"/><span>更多模板</span></a></li>
    </ul>
